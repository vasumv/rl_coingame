...
class GameBoard():
    def __init__(self, size, num_enemies, num_coins, grid_radius):
        ...
        self.size = size
        x_player_vals = random.sample(range(self.size), self.num_enemies + 1)
        y_player_vals = random.sample(range(self.size), self.num_enemies + 1)
        x_coin_vals = random.sample(range(self.size), self.num_coins)
        y_coin_vals = random.sample(range(self.size), self.num_coins)
